...
MACRO_CONFIG_STR(SvScepticEnergynatorA, sv_scepticenergynator_a, 128, "修复仪: 你是个突变体, 不是吗?", CFGFLAG_SERVER, "Sceptic energynator text 1")
MACRO_CONFIG_STR(SvScepticEnergynatorB, sv_scepticenergynator_b, 128, "修复仪: 启动修复... 嘿等会!", CFGFLAG_SERVER, "Sceptic energynator text 2")
MACRO_CONFIG_STR(SvScepticEnergynatorC, sv_scepticenergynator_c, 128, "修复仪: 滚开可怕的突变体!", CFGFLAG_SERVER, "Sceptic energynator text 3")
MACRO_CONFIG_STR(SvScepticEnergynatorD, sv_scepticenergynator_d, 128, "修复仪: (笑)", CFGFLAG_SERVER, "Sceptic energynator text 4")
MACRO_CONFIG_STR(SvScepticEnergynatorE, sv_scepticenergynator_e, 128, "修复仪: 救命!!! 我要被突变体摧毁了!", CFGFLAG_SERVER, "Sceptic energynator text 5")
